...
ggplot(data=rwi.precip.df) + geom_point(aes(x=precip, y=rwi)) + ylim(c(0, 2)) + ggtitle("Scatterplot of Precipitation to RWI") + theme(plot.title=element_text(lineheight=4, face="bold", size=30))
...
ggplot(data=rwi.precip.df.sub) + geom_line(aes(x=year, y=resid)) + ggtitle("Residuals plotted along time") + theme(plot.title=element_text(lineheight=4, face="bold", size=30))
