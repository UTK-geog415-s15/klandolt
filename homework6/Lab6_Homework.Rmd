...
The summary of this regression shows all the regressed independent variables as significant with women as the only negative coefficient. However, transforming education and prestige to exp(education) and exp(prestige) put the data into a nonsensical format. Looking at the component + residual plots, the exp(prestige) independent variable does not express the linear relationship so desired. I will now only log(income) and observe the results:
...
After logging income, I see that there is significant relationships to the intercent
