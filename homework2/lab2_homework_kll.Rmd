...
ggplot(data=totcor) + geom_point(aes(x=month, y=cor.r, color='Correlation of current year')) + geom_point(aes(x=month, y=corlag.r, color='Correlation of lagged year'))
```
