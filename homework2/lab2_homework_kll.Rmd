...
ggplot(data=totcor) + geom_point(aes(x=month, y=cor.r, color='current year')) + geom_point(aes(x=month, y=corlag.r, color='lagged year')) + labs(color='Correlation of') + geom_abline(intercept=0, slope=0) + labs(x='Month', y= 'Correlation value (r)')
