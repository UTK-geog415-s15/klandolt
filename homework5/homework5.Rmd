...
The correlates of *house price* to the other factors are:

 - **AGE** has a correlation value of -0.455
 - **RM** has a positive correlation value 0.633
 - **logDIS** has a positive correlation value of 0.406
 - **B** has a positve correlation value of 0.405
 - **LSTAT** has a strong correlation value of -0.809
 - **PTRATIO** has a correlation value of -0.499
 - **NOX** has a correlation value of -0.513
 
 b. Describe the correlates of NOX.
 
The correlates of *NOX* to the other factors are:

 - **AGE** has a correlation value of 0.731
 - **RM** has a correlation value -0.302
 - **logDIS** has a positive correlation value of -0.832
 - **B** has a positve correlation value of -.38
 - **LSTAT** has a strong correlation value of 0.591
 - **PTRATIO** has a correlation value of 0.189
 - **logCMEDV** has a correlation value of -0.513
