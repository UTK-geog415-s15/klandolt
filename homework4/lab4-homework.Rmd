...
The will be a difference in the mean of the male ACT scores and the mean of the female ACT score. The difference of the means will not be equal 0.
```
...
case0301 %>% group_by(Treatment) %>% summarize(m=mean(log(Rainfall)), sd=sd(Rainfall), n=n() )
...
```{r}
case0502$Judge2 <- ifelse(case0502$Judge, "Spocks", "Other")
```
